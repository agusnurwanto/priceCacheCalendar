...
var jsonFile = path.resolve(__dirname, 'jog-pnk-rt.json');
var resultFile = path.resolve(__dirname, 'result.json');

var mockBody = {dep_date: "06+09+2015", ret_date: "12+09+2015", ori: 'PNK', dst: 'JOG'};
// var mockDataExpress = fs.readFileSync('./ex.html', 'utf8');
var mockDataExpress = '';

var debug       = require('debug')('raabbajam:priceCacheCalendar:test:express:spec');
describe.skip('Price Generator for Express', function () {
	this.timeout(20000);
